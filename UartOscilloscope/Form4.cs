...
{                                                                               //  進入命名空間
    ...
    {                                                                           //  進入Form4類別
        ...
        private void Form4_Load(object sender, EventArgs e)                     //  宣告Form4_Load方法，Form4表單載入時執行
        {                                                                       //  進入Form4_Load方法
            textBox2.UseSystemPasswordChar = true;                              //  設定textBox2(密碼輸入欄位)顯示字元隱藏
        }                                                                       //  結束Form4_Load方法
        private void button1_Click(object sender, EventArgs e)                  //  宣告button1_Click方法，按下"登入除錯模式"按鈕時執行
        {                                                                       //  進入button1_Click方法
            //  輸入資訊檢查
