...
{                                                                               //  進入命名空間
    ...
    {                                                                           //  進入Form3類別
        ...
        private void button1_Click(object sender, System.EventArgs e)           //  宣告button1_Click副程式，按下"儲存"按鈕時執行
        {                                                                       //  進入button1_Click副程式

            Close();                                                            //  關閉表單
        }                                                                       //  結束button1_Click副程式

        private void button2_Click(object sender, System.EventArgs e)           //  宣告button2_Click副程式，按下"字型"按鈕時執行
        {                                                                       //  進入button2_Click副程式
        ...
        private void button3_Click(object sender, System.EventArgs e)           //  宣告button3_Click副程式，按下"登入除錯介面"按鈕時執行
        {                                                                       //  進入button3_Click副程式
