...
{                                                                               //	進入命名空間
	...
	{                                                                           //	進入ErrorCodeMessage類別
		...
		public static void Error_Message_Show(ErrorCodeEncoding ErrorCode_input)
		{                                                                       //  進入Error_Message_Show方法
			switch (ErrorCode_input)
			{                                                                   //  進入switch敘述
				case ErrorCodeEncoding.NoSerialPortConnected:
					...
					break;
				case ErrorCodeEncoding.NoSerialPortSelected:
					...
					break;
				case ErrorCodeEncoding.SerialPortConnectError:
